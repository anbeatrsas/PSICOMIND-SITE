<?php
    ...
    $profissional = $conn->query("SELECT * FROM profissionais");

    $horarios = $conn->query("SELECT id, horario FROM escala WHERE dia = '$dia' and profissional_id = $profissional_id and disponivel = 1");
